					...
					<div id="access-token" class="content-wrapper">
						...
						<div class="content">
							...
							<?php else : ?>
								...
								<a class="button button-large reset-token" id="catch-instagram-feed-gallery-widget-reset" href="<?php echo esc_attr( $catch_instagram_feed_gallery_widget_page ) . '&q=logout'; ?>"><?php esc_html_e( 'Logout', 'catch-instagram-feed-gallery-widget' ); ?></a>
							<?php endif; ?>
